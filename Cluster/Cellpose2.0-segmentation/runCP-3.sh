...
#SBATCH --array=97-107%6          # Run array of 6 simultaneous jobs from 97 to 107 in case_list
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gpus-per-node=v100l:1
#SBATCH --mem=8G
#SBATCH --time=98:00:00           # Time is set to 98 hours for each job in the array
