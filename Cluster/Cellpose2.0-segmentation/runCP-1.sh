...
#SBATCH --array=1-57%20		  # Run array of 20 simultaneous jobs from 1 to 57 in case_list
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gpus-per-node=v100l:1
#SBATCH --mem=8G
#SBATCH --time=50:00:00		  # Time is set to 50 hours for each job in the array
