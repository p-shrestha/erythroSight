...
#SBATCH --array=58-96%15          # Run array of 15 simultaneous jobs from 58 to 96 in case_list
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gpus-per-node=v100l:1
#SBATCH --mem=8G
#SBATCH --time=80:00:00           # Time is set to 80 hours for each job in the array
