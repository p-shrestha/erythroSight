function [trainedClassifier22BoostedTree, validationAccuracy] = trainClassifier22BoostedTree(trainingData)
% [trainedClassifier22BoostedTree, validationAccuracy] = trainClassifier22BoostedTree(trainingData)
% Returns a trained Classifier22BoostedTree and its accuracy. This code recreates the
...
%
%  Output:
%      trainedClassifier22BoostedTree: A struct containing the trained Classifier22BoostedTree. The
%       struct contains various fields with information about the trained
%       Classifier22BoostedTree.
%
%      trainedClassifier22BoostedTree.predictFcn: A function to make predictions on new
%       data.
%
...
% Classifier22BoostedTree, call the function from the command line with your original
% data or new data as the input argument trainingData.
%
% For example, to retrain a Classifier22BoostedTree trained with the original data set
% T, enter:
%   [trainedClassifier22BoostedTree, validationAccuracy] = trainClassifier22BoostedTree(T)
%
% To make predictions with the returned 'trainedClassifier22BoostedTree' on new data T2,
% use
%   [yfit,scores] = trainedClassifier22BoostedTree.predictFcn(T2)
%
% T2 must be a table containing at least the same predictor columns as used
% during training. For details, enter:
%   trainedClassifier22BoostedTree.HowToPredict

% Auto-generated by MATLAB on 29-Aug-2023 22:22:04
...
% Train a Classifier22BoostedTree
% This code specifies all the Classifier22BoostedTree options and trains the Classifier22BoostedTree.
...
partitionedModel = crossval(trainedClassifier22BoostedTree.ClassificationEnsemble, 'KFold', 10);
