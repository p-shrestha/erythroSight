function [trainedClassifier17MedKNN, validationAccuracy] = trainClassifier17MedKNN(trainingData)
% [trainedClassifier17MedKNN, validationAccuracy] = trainClassifier17MedKNN(trainingData)
% Returns a trained Classifier17MedKNN and its accuracy. This code recreates the
...
%
%  Output:
%      trainedClassifier17MedKNN: A struct containing the trained Classifier17MedKNN. The
%       struct contains various fields with information about the trained
%       Classifier17MedKNN.
%
%      trainedClassifier17MedKNN.predictFcn: A function to make predictions on new
%       data.
%
...
% Classifier17MedKNN, call the function from the command line with your original
% data or new data as the input argument trainingData.
%
% For example, to retrain a Classifier17MedKNN trained with the original data set
% T, enter:
%   [trainedClassifier17MedKNN, validationAccuracy] = trainClassifier17MedKNN(T)
%
% To make predictions with the returned 'trainedClassifier17MedKNN' on new data T2,
% use
%   [yfit,scores] = trainedClassifier17MedKNN.predictFcn(T2)
%
% T2 must be a table containing at least the same predictor columns as used
% during training. For details, enter:
%   trainedClassifier17MedKNN.HowToPredict

% Auto-generated by MATLAB on 29-Aug-2023 22:19:50
...
% Train a Classifier17MedKNN
% This code specifies all the Classifier17MedKNN options and trains the Classifier17MedKNN.
...
partitionedModel = crossval(trainedClassifier17MedKNN.ClassificationKNN, 'KFold', 10);
