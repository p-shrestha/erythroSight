function [trainedClassifier2MediumTree, validationAccuracy] = trainClassifier2MediumTree(trainingData)
% [trainedClassifier2MediumTree, validationAccuracy] = trainClassifier2MediumTree(trainingData)
% Returns a trained Classifier2MediumTree and its accuracy. This code recreates the
...
%
%  Output:
%      trainedClassifier2MediumTree: A struct containing the trained Classifier2MediumTree. The
%       struct contains various fields with information about the trained
%       Classifier2MediumTree.
%
%      trainedClassifier2MediumTree.predictFcn: A function to make predictions on new
%       data.
%
...
% Classifier2MediumTree, call the function from the command line with your original
% data or new data as the input argument trainingData.
%
% For example, to retrain a Classifier2MediumTree trained with the original data set
% T, enter:
%   [trainedClassifier2MediumTree, validationAccuracy] = trainClassifier2MediumTree(T)
%
% To make predictions with the returned 'trainedClassifier2MediumTree' on new data T2,
% use
%   [yfit,scores] = trainedClassifier2MediumTree.predictFcn(T2)
%
% T2 must be a table containing at least the same predictor columns as used
% during training. For details, enter:
%   trainedClassifier2MediumTree.HowToPredict

% Auto-generated by MATLAB on 29-Aug-2023 22:13:45
...
% Train a Classifier2MediumTree
% This code specifies all the Classifier2MediumTree options and trains the Classifier2MediumTree.
...
partitionedModel = crossval(trainedClassifier2MediumTree.ClassificationTree, 'KFold', 10);
