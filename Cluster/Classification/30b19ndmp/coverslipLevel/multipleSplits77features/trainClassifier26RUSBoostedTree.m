function [trainedClassifier26RUSBoostedTree, validationAccuracy] = trainClassifier26RUSBoostedTree(trainingData)
% [trainedClassifier26RUSBoostedTree, validationAccuracy] = trainClassifier26RUSBoostedTree(trainingData)
% Returns a trained Classifier26RUSBoostedTree and its accuracy. This code recreates the
...
%
%  Output:
%      trainedClassifier26RUSBoostedTree: A struct containing the trained Classifier26RUSBoostedTree. The
%       struct contains various fields with information about the trained
%       Classifier26RUSBoostedTree.
%
%      trainedClassifier26RUSBoostedTree.predictFcn: A function to make predictions on new
%       data.
%
...
% Classifier26RUSBoostedTree, call the function from the command line with your original
% data or new data as the input argument trainingData.
%
% For example, to retrain a Classifier26RUSBoostedTree trained with the original data set
% T, enter:
%   [trainedClassifier26RUSBoostedTree, validationAccuracy] = trainClassifier26RUSBoostedTree(T)
%
% To make predictions with the returned 'trainedClassifier26RUSBoostedTree' on new data T2,
% use
%   [yfit,scores] = trainedClassifier26RUSBoostedTree.predictFcn(T2)
%
% T2 must be a table containing at least the same predictor columns as used
% during training. For details, enter:
%   trainedClassifier26RUSBoostedTree.HowToPredict

% Auto-generated by MATLAB on 29-Aug-2023 22:23:40
...
% Train a Classifier26RUSBoostedTree
% This code specifies all the Classifier26RUSBoostedTree options and trains the Classifier26RUSBoostedTree.
...
partitionedModel = crossval(trainedClassifier26RUSBoostedTree.ClassificationEnsemble, 'KFold', 10);
