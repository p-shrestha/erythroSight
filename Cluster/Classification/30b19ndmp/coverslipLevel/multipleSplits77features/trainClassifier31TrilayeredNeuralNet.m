function [trainedClassifier31TrilayeredNeuralNet, validationAccuracy] = trainClassifier31TrilayeredNeuralNet(trainingData)
% [trainedClassifier31TrilayeredNeuralNet, validationAccuracy] = trainClassifier31TrilayeredNeuralNet(trainingData)
% Returns a trained Classifier31TrilayeredNeuralNet and its accuracy. This code recreates the
...
%
%  Output:
%      trainedClassifier31TrilayeredNeuralNet: A struct containing the trained Classifier31TrilayeredNeuralNet. The
%       struct contains various fields with information about the trained
%       Classifier31TrilayeredNeuralNet.
%
%      trainedClassifier31TrilayeredNeuralNet.predictFcn: A function to make predictions on new
%       data.
%
...
% Classifier31TrilayeredNeuralNet, call the function from the command line with your original
% data or new data as the input argument trainingData.
%
% For example, to retrain a Classifier31TrilayeredNeuralNet trained with the original data set
% T, enter:
%   [trainedClassifier31TrilayeredNeuralNet, validationAccuracy] = trainClassifier31TrilayeredNeuralNet(T)
%
% To make predictions with the returned 'trainedClassifier31TrilayeredNeuralNet' on new data T2,
% use
%   [yfit,scores] = trainedClassifier31TrilayeredNeuralNet.predictFcn(T2)
%
% T2 must be a table containing at least the same predictor columns as used
% during training. For details, enter:
%   trainedClassifier31TrilayeredNeuralNet.HowToPredict

% Auto-generated by MATLAB on 29-Aug-2023 22:25:40
...
% Train a Classifier31TrilayeredNeuralNet
% This code specifies all the Classifier31TrilayeredNeuralNet options and trains the Classifier31TrilayeredNeuralNet.
...
partitionedModel = crossval(trainedClassifier31TrilayeredNeuralNet.ClassificationNeuralNetwork, 'KFold', 10);
