function [trainedClassifier14MedGaussSVM, validationAccuracy] = trainClassifier14MedGaussSVM(trainingData)
% [trainedClassifier14MedGaussSVM, validationAccuracy] = trainClassifier14MedGaussSVM(trainingData)
% Returns a trained Classifier14MedGaussSVM and its accuracy. This code recreates the
...
%
%  Output:
%      trainedClassifier14MedGaussSVM: A struct containing the trained Classifier14MedGaussSVM. The
%       struct contains various fields with information about the trained
%       Classifier14MedGaussSVM.
%
%      trainedClassifier14MedGaussSVM.predictFcn: A function to make predictions on new
%       data.
%
...
% Classifier14MedGaussSVM, call the function from the command line with your original
% data or new data as the input argument trainingData.
%
% For example, to retrain a Classifier14MedGaussSVM trained with the original data set
% T, enter:
%   [trainedClassifier14MedGaussSVM, validationAccuracy] = trainClassifier14MedGaussSVM(T)
%
% To make predictions with the returned 'trainedClassifier14MedGaussSVM' on new data T2,
% use
%   [yfit,scores] = trainedClassifier14MedGaussSVM.predictFcn(T2)
%
% T2 must be a table containing at least the same predictor columns as used
% during training. For details, enter:
%   trainedClassifier14MedGaussSVM.HowToPredict

% Auto-generated by MATLAB on 29-Aug-2023 22:18:36
...
% Train a Classifier14MedGaussSVM
% This code specifies all the Classifier14MedGaussSVM options and trains the Classifier14MedGaussSVM.
template = templateSVM(...
    'KernelFunction', 'gaussian', ...
    'PolynomialOrder', [], ...
    'KernelScale', 8.800000000000001, ...
    'BoxConstraint', 1, ...
    'Standardize', true);
...
partitionedModel = crossval(trainedClassifier14MedGaussSVM.ClassificationSVM, 'KFold', 10);
