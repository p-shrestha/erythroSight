function [trainedClassifier23BaggedTree, validationAccuracy] = trainClassifier23BaggedTree(trainingData)
% [trainedClassifier23BaggedTree, validationAccuracy] = trainClassifier23BaggedTree(trainingData)
% Returns a trained Classifier23BaggedTree and its accuracy. This code recreates the
...
%
%  Output:
%      trainedClassifier23BaggedTree: A struct containing the trained Classifier23BaggedTree. The
%       struct contains various fields with information about the trained
%       Classifier23BaggedTree.
%
%      trainedClassifier23BaggedTree.predictFcn: A function to make predictions on new
%       data.
%
...
% Classifier23BaggedTree, call the function from the command line with your original
% data or new data as the input argument trainingData.
%
% For example, to retrain a Classifier23BaggedTree trained with the original data set
% T, enter:
%   [trainedClassifier23BaggedTree, validationAccuracy] = trainClassifier23BaggedTree(T)
%
% To make predictions with the returned 'trainedClassifier23BaggedTree' on new data T2,
% use
%   [yfit,scores] = trainedClassifier23BaggedTree.predictFcn(T2)
%
% T2 must be a table containing at least the same predictor columns as used
% during training. For details, enter:
%   trainedClassifier23BaggedTree.HowToPredict

% Auto-generated by MATLAB on 29-Aug-2023 22:22:29
...
% Train a Classifier23BaggedTree
% This code specifies all the Classifier23BaggedTree options and trains the Classifier23BaggedTree.
...
partitionedModel = crossval(trainedClassifier23BaggedTree.ClassificationEnsemble, 'KFold', 10);
