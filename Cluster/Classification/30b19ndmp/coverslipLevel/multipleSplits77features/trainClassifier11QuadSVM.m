function [trainedClassifier11QuadSVM, validationAccuracy] = trainClassifier11QuadSVM(trainingData)
% [trainedClassifier11QuadSVM, validationAccuracy] = trainClassifier11QuadSVM(trainingData)
% Returns a trained Classifier11QuadSVM and its accuracy. This code recreates the
...
%
%  Output:
%      trainedClassifier11QuadSVM: A struct containing the trained Classifier11QuadSVM. The
%       struct contains various fields with information about the trained
%       Classifier11QuadSVM.
%
%      trainedClassifier11QuadSVM.predictFcn: A function to make predictions on new
%       data.
%
...
% Classifier11QuadSVM, call the function from the command line with your original
% data or new data as the input argument trainingData.
%
% For example, to retrain a Classifier11QuadSVM trained with the original data set
% T, enter:
%   [trainedClassifier11QuadSVM, validationAccuracy] = trainClassifier11QuadSVM(T)
%
% To make predictions with the returned 'trainedClassifier11QuadSVM' on new data T2,
% use
%   [yfit,scores] = trainedClassifier11QuadSVM.predictFcn(T2)
%
% T2 must be a table containing at least the same predictor columns as used
% during training. For details, enter:
%   trainedClassifier11QuadSVM.HowToPredict

% Auto-generated by MATLAB on 29-Aug-2023 22:17:13
...
% Train a Classifier11QuadSVM
% This code specifies all the Classifier11QuadSVM options and trains the Classifier11QuadSVM.
...
partitionedModel = crossval(trainedClassifier11QuadSVM.ClassificationSVM, 'KFold', 10);
