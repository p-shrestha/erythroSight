function [trainedClassifier21WeightedKNN, validationAccuracy] = trainClassifier21WeightedKNN(trainingData)
% [trainedClassifier21WeightedKNN, validationAccuracy] = trainClassifier21WeightedKNN(trainingData)
% Returns a trained Classifier21WeightedKNN and its accuracy. This code recreates the
...
%
%  Output:
%      trainedClassifier21WeightedKNN: A struct containing the trained Classifier21WeightedKNN. The
%       struct contains various fields with information about the trained
%       Classifier21WeightedKNN.
%
%      trainedClassifier21WeightedKNN.predictFcn: A function to make predictions on new
%       data.
%
...
% Classifier21WeightedKNN, call the function from the command line with your original
% data or new data as the input argument trainingData.
%
% For example, to retrain a Classifier21WeightedKNN trained with the original data set
% T, enter:
%   [trainedClassifier21WeightedKNN, validationAccuracy] = trainClassifier21WeightedKNN(T)
%
% To make predictions with the returned 'trainedClassifier21WeightedKNN' on new data T2,
% use
%   [yfit,scores] = trainedClassifier21WeightedKNN.predictFcn(T2)
%
% T2 must be a table containing at least the same predictor columns as used
% during training. For details, enter:
%   trainedClassifier21WeightedKNN.HowToPredict

% Auto-generated by MATLAB on 29-Aug-2023 22:21:35
...
% Train a Classifier21WeightedKNN
% This code specifies all the Classifier21WeightedKNN options and trains the Classifier21WeightedKNN.
...
partitionedModel = crossval(trainedClassifier21WeightedKNN.ClassificationKNN, 'KFold', 10);
