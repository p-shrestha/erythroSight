function [trainedClassifier1FineTree, validationAccuracy] = trainClassifier1FineTree(trainingData)
% [trainedClassifier1FineTree, validationAccuracy] = trainClassifier1FineTree(trainingData)
% Returns a trained Classifier1FineTree and its accuracy. This code recreates the
...
%
%  Output:
%      trainedClassifier1FineTree: A struct containing the trained Classifier1FineTree. The
%       struct contains various fields with information about the trained
%       Classifier1FineTree.
%
%      trainedClassifier1FineTree.predictFcn: A function to make predictions on new
%       data.
%
...
% Classifier1FineTree, call the function from the command line with your original
% data or new data as the input argument trainingData.
%
% For example, to retrain a Classifier1FineTree trained with the original data set
% T, enter:
%   [trainedClassifier1FineTree, validationAccuracy] = trainClassifier1FineTree(T)
%
% To make predictions with the returned 'trainedClassifier1FineTree' on new data T2,
% use
%   [yfit,scores] = trainedClassifier1FineTree.predictFcn(T2)
%
% T2 must be a table containing at least the same predictor columns as used
% during training. For details, enter:
%   trainedClassifier1FineTree.HowToPredict

% Auto-generated by MATLAB on 29-Aug-2023 22:13:13
...
% Train a Classifier1FineTree
% This code specifies all the Classifier1FineTree options and trains the Classifier1FineTree.
...
partitionedModel = crossval(trainedClassifier1FineTree.ClassificationTree, 'KFold', 10);
