function [trainedClassifier16FineKNN, validationAccuracy] = trainClassifier16FineKNN(trainingData)
% [trainedClassifier16FineKNN, validationAccuracy] = trainClassifier16FineKNN(trainingData)
% Returns a trained Classifier16FineKNN and its accuracy. This code recreates the
...
%
%  Output:
%      trainedClassifier16FineKNN: A struct containing the trained Classifier16FineKNN. The
%       struct contains various fields with information about the trained
%       Classifier16FineKNN.
%
%      trainedClassifier16FineKNN.predictFcn: A function to make predictions on new
%       data.
%
...
% Classifier16FineKNN, call the function from the command line with your original
% data or new data as the input argument trainingData.
%
% For example, to retrain a Classifier16FineKNN trained with the original data set
% T, enter:
%   [trainedClassifier16FineKNN, validationAccuracy] = trainClassifier16FineKNN(T)
%
% To make predictions with the returned 'trainedClassifier16FineKNN' on new data T2,
% use
%   [yfit,scores] = trainedClassifier16FineKNN.predictFcn(T2)
%
% T2 must be a table containing at least the same predictor columns as used
% during training. For details, enter:
%   trainedClassifier16FineKNN.HowToPredict

% Auto-generated by MATLAB on 29-Aug-2023 22:19:26
...
% Train a Classifier16FineKNN
% This code specifies all the Classifier16FineKNN options and trains the Classifier16FineKNN.
...
partitionedModel = crossval(trainedClassifier16FineKNN.ClassificationKNN, 'KFold', 10);
