function [trainedClassifier18CoarseKNN, validationAccuracy] = trainClassifier18CoarseKNN(trainingData)
% [trainedClassifier18CoarseKNN, validationAccuracy] = trainClassifier18CoarseKNN(trainingData)
% Returns a trained Classifier18CoarseKNN and its accuracy. This code recreates the
...
%
%  Output:
%      trainedClassifier18CoarseKNN: A struct containing the trained Classifier18CoarseKNN. The
%       struct contains various fields with information about the trained
%       Classifier18CoarseKNN.
%
%      trainedClassifier18CoarseKNN.predictFcn: A function to make predictions on new
%       data.
%
...
% Classifier18CoarseKNN, call the function from the command line with your original
% data or new data as the input argument trainingData.
%
% For example, to retrain a Classifier18CoarseKNN trained with the original data set
% T, enter:
%   [trainedClassifier18CoarseKNN, validationAccuracy] = trainClassifier18CoarseKNN(T)
%
% To make predictions with the returned 'trainedClassifier18CoarseKNN' on new data T2,
% use
%   [yfit,scores] = trainedClassifier18CoarseKNN.predictFcn(T2)
%
% T2 must be a table containing at least the same predictor columns as used
% during training. For details, enter:
%   trainedClassifier18CoarseKNN.HowToPredict

% Auto-generated by MATLAB on 29-Aug-2023 22:20:14
...
% Train a Classifier18CoarseKNN
% This code specifies all the Classifier18CoarseKNN options and trains the Classifier18CoarseKNN.
...
partitionedModel = crossval(trainedClassifier18CoarseKNN.ClassificationKNN, 'KFold', 10);
