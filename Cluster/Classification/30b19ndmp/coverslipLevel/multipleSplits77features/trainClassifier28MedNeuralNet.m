function [trainedClassifier28MedNeuralNet, validationAccuracy] = trainClassifier28MedNeuralNet(trainingData)
% [trainedClassifier28MedNeuralNet, validationAccuracy] = trainClassifier28MedNeuralNet(trainingData)
% Returns a trained Classifier28MedNeuralNet and its accuracy. This code recreates the
...
%
%  Output:
%      trainedClassifier28MedNeuralNet: A struct containing the trained Classifier28MedNeuralNet. The
%       struct contains various fields with information about the trained
%       Classifier28MedNeuralNet.
%
%      trainedClassifier28MedNeuralNet.predictFcn: A function to make predictions on new
%       data.
%
...
% Classifier28MedNeuralNet, call the function from the command line with your original
% data or new data as the input argument trainingData.
%
% For example, to retrain a Classifier28MedNeuralNet trained with the original data set
% T, enter:
%   [trainedClassifier28MedNeuralNet, validationAccuracy] = trainClassifier28MedNeuralNet(T)
%
% To make predictions with the returned 'trainedClassifier28MedNeuralNet' on new data T2,
% use
%   [yfit,scores] = trainedClassifier28MedNeuralNet.predictFcn(T2)
%
% T2 must be a table containing at least the same predictor columns as used
% during training. For details, enter:
%   trainedClassifier28MedNeuralNet.HowToPredict

% Auto-generated by MATLAB on 29-Aug-2023 22:24:35
...
% Train a Classifier28MedNeuralNet
% This code specifies all the Classifier28MedNeuralNet options and trains the Classifier28MedNeuralNet.
...
partitionedModel = crossval(trainedClassifier28MedNeuralNet.ClassificationNeuralNetwork, 'KFold', 10);
