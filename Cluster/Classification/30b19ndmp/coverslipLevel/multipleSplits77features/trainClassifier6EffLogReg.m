function [trainedClassifier6EffLogReg, validationAccuracy] = trainClassifier6EffLogReg(trainingData)
% [trainedClassifier6EffLogReg, validationAccuracy] = trainClassifier6EffLogReg(trainingData)
% Returns a trained Classifier6EffLogReg and its accuracy. This code recreates the
...
%
%  Output:
%      trainedClassifier6EffLogReg: A struct containing the trained Classifier6EffLogReg. The
%       struct contains various fields with information about the trained
%       Classifier6EffLogReg.
%
%      trainedClassifier6EffLogReg.predictFcn: A function to make predictions on new
%       data.
%
...
% Classifier6EffLogReg, call the function from the command line with your original
% data or new data as the input argument trainingData.
%
% For example, to retrain a Classifier6EffLogReg trained with the original data set
% T, enter:
%   [trainedClassifier6EffLogReg, validationAccuracy] = trainClassifier6EffLogReg(T)
%
% To make predictions with the returned 'trainedClassifier6EffLogReg' on new data T2,
% use
%   [yfit,scores] = trainedClassifier6EffLogReg.predictFcn(T2)
%
% T2 must be a table containing at least the same predictor columns as used
% during training. For details, enter:
%   trainedClassifier6EffLogReg.HowToPredict

% Auto-generated by MATLAB on 29-Aug-2023 22:15:23
...
% Train a Classifier6EffLogReg
% This code specifies all the Classifier6EffLogReg options and trains the Classifier6EffLogReg.
