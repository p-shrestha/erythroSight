function [trainedClassifier7EffLinSVM, validationAccuracy] = trainClassifier7EffLinSVM(trainingData)
% [trainedClassifier7EffLinSVM, validationAccuracy] = trainClassifier7EffLinSVM(trainingData)
% Returns a trained Classifier7EffLinSVM and its accuracy. This code recreates the
...
%
%  Output:
%      trainedClassifier7EffLinSVM: A struct containing the trained Classifier7EffLinSVM. The
%       struct contains various fields with information about the trained
%       Classifier7EffLinSVM.
%
%      trainedClassifier7EffLinSVM.predictFcn: A function to make predictions on new
%       data.
%
...
% Classifier7EffLinSVM, call the function from the command line with your original
% data or new data as the input argument trainingData.
%
% For example, to retrain a Classifier7EffLinSVM trained with the original data set
% T, enter:
%   [trainedClassifier7EffLinSVM, validationAccuracy] = trainClassifier7EffLinSVM(T)
%
% To make predictions with the returned 'trainedClassifier7EffLinSVM' on new data T2,
% use
%   [yfit,scores] = trainedClassifier7EffLinSVM.predictFcn(T2)
%
% T2 must be a table containing at least the same predictor columns as used
% during training. For details, enter:
%   trainedClassifier7EffLinSVM.HowToPredict

% Auto-generated by MATLAB on 29-Aug-2023 22:15:55
...
% Train a Classifier7EffLinSVM
% This code specifies all the Classifier7EffLinSVM options and trains the Classifier7EffLinSVM.
