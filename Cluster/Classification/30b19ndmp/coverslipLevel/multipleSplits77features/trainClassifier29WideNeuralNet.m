function [trainedClassifier29WideNeuralNet, validationAccuracy] = trainClassifier29WideNeuralNet(trainingData)
% [trainedClassifier29WideNeuralNet, validationAccuracy] = trainClassifier29WideNeuralNet(trainingData)
% Returns a trained Classifier29WideNeuralNet and its accuracy. This code recreates the
...
%
%  Output:
%      trainedClassifier29WideNeuralNet: A struct containing the trained Classifier29WideNeuralNet. The
%       struct contains various fields with information about the trained
%       Classifier29WideNeuralNet.
%
%      trainedClassifier29WideNeuralNet.predictFcn: A function to make predictions on new
%       data.
%
...
% Classifier29WideNeuralNet, call the function from the command line with your original
% data or new data as the input argument trainingData.
%
% For example, to retrain a Classifier29WideNeuralNet trained with the original data set
% T, enter:
%   [trainedClassifier29WideNeuralNet, validationAccuracy] = trainClassifier29WideNeuralNet(T)
%
% To make predictions with the returned 'trainedClassifier29WideNeuralNet' on new data T2,
% use
%   [yfit,scores] = trainedClassifier29WideNeuralNet.predictFcn(T2)
%
% T2 must be a table containing at least the same predictor columns as used
% during training. For details, enter:
%   trainedClassifier29WideNeuralNet.HowToPredict

% Auto-generated by MATLAB on 29-Aug-2023 22:24:57
...
% Train a Classifier29WideNeuralNet
% This code specifies all the Classifier29WideNeuralNet options and trains the Classifier29WideNeuralNet.
...
partitionedModel = crossval(trainedClassifier29WideNeuralNet.ClassificationNeuralNetwork, 'KFold', 10);
