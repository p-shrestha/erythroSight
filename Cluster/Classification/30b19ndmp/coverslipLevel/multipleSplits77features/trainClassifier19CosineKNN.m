function [trainedClassifier19CosineKNN, validationAccuracy] = trainClassifier19CosineKNN(trainingData)
% [trainedClassifier19CosineKNN, validationAccuracy] = trainClassifier19CosineKNN(trainingData)
% Returns a trained Classifier19CosineKNN and its accuracy. This code recreates the
...
%
%  Output:
%      trainedClassifier19CosineKNN: A struct containing the trained Classifier19CosineKNN. The
%       struct contains various fields with information about the trained
%       Classifier19CosineKNN.
%
%      trainedClassifier19CosineKNN.predictFcn: A function to make predictions on new
%       data.
%
...
% Classifier19CosineKNN, call the function from the command line with your original
% data or new data as the input argument trainingData.
%
% For example, to retrain a Classifier19CosineKNN trained with the original data set
% T, enter:
%   [trainedClassifier19CosineKNN, validationAccuracy] = trainClassifier19CosineKNN(T)
%
% To make predictions with the returned 'trainedClassifier19CosineKNN' on new data T2,
% use
%   [yfit,scores] = trainedClassifier19CosineKNN.predictFcn(T2)
%
% T2 must be a table containing at least the same predictor columns as used
% during training. For details, enter:
%   trainedClassifier19CosineKNN.HowToPredict

% Auto-generated by MATLAB on 29-Aug-2023 22:20:50
...
% Train a Classifier19CosineKNN
% This code specifies all the Classifier19CosineKNN options and trains the Classifier19CosineKNN.
...
partitionedModel = crossval(trainedClassifier19CosineKNN.ClassificationKNN, 'KFold', 10);
