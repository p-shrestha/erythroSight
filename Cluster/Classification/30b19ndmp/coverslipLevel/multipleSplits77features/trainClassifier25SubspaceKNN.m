function [trainedClassifier25SubspaceKNN, validationAccuracy] = trainClassifier25SubspaceKNN(trainingData)
% [trainedClassifier25SubspaceKNN, validationAccuracy] = trainClassifier25SubspaceKNN(trainingData)
% Returns a trained Classifier25SubspaceKNN and its accuracy. This code recreates the
...
%
%  Output:
%      trainedClassifier25SubspaceKNN: A struct containing the trained Classifier25SubspaceKNN. The
%       struct contains various fields with information about the trained
%       Classifier25SubspaceKNN.
%
%      trainedClassifier25SubspaceKNN.predictFcn: A function to make predictions on new
%       data.
%
...
% Classifier25SubspaceKNN, call the function from the command line with your original
% data or new data as the input argument trainingData.
%
% For example, to retrain a Classifier25SubspaceKNN trained with the original data set
% T, enter:
%   [trainedClassifier25SubspaceKNN, validationAccuracy] = trainClassifier25SubspaceKNN(T)
%
% To make predictions with the returned 'trainedClassifier25SubspaceKNN' on new data T2,
% use
%   [yfit,scores] = trainedClassifier25SubspaceKNN.predictFcn(T2)
%
% T2 must be a table containing at least the same predictor columns as used
% during training. For details, enter:
%   trainedClassifier25SubspaceKNN.HowToPredict

% Auto-generated by MATLAB on 29-Aug-2023 22:23:16
...
% Train a Classifier25SubspaceKNN
% This code specifies all the Classifier25SubspaceKNN options and trains the Classifier25SubspaceKNN.
...
partitionedModel = crossval(trainedClassifier25SubspaceKNN.ClassificationEnsemble, 'KFold', 10);
