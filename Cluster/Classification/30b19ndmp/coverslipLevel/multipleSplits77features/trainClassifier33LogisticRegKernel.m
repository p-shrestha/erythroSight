function [trainedClassifier33LogisticRegKernel, validationAccuracy] = trainClassifier33LogisticRegKernel(trainingData)
% [trainedClassifier33LogisticRegKernel, validationAccuracy] = trainClassifier33LogisticRegKernel(trainingData)
% Returns a trained Classifier33LogisticRegKernel and its accuracy. This code recreates the
...
%
%  Output:
%      trainedClassifier33LogisticRegKernel: A struct containing the trained Classifier33LogisticRegKernel. The
%       struct contains various fields with information about the trained
%       Classifier33LogisticRegKernel.
%
%      trainedClassifier33LogisticRegKernel.predictFcn: A function to make predictions on new
%       data.
%
...
% Classifier33LogisticRegKernel, call the function from the command line with your original
% data or new data as the input argument trainingData.
%
% For example, to retrain a Classifier33LogisticRegKernel trained with the original data set
% T, enter:
%   [trainedClassifier33LogisticRegKernel, validationAccuracy] = trainClassifier33LogisticRegKernel(T)
%
% To make predictions with the returned 'trainedClassifier33LogisticRegKernel' on new data T2,
% use
%   [yfit,scores] = trainedClassifier33LogisticRegKernel.predictFcn(T2)
%
% T2 must be a table containing at least the same predictor columns as used
% during training. For details, enter:
%   trainedClassifier33LogisticRegKernel.HowToPredict

% Auto-generated by MATLAB on 29-Aug-2023 22:26:30
...
% Train a Classifier33LogisticRegKernel
% This code specifies all the Classifier33LogisticRegKernel options and trains the Classifier33LogisticRegKernel.
