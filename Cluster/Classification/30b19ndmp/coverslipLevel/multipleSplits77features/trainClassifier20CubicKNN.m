function [trainedClassifier20CubicKNN, validationAccuracy] = trainClassifier20CubicKNN(trainingData)
% [trainedClassifier20CubicKNN, validationAccuracy] = trainClassifier20CubicKNN(trainingData)
% Returns a trained Classifier20CubicKNN and its accuracy. This code recreates the
...
%
%  Output:
%      trainedClassifier20CubicKNN: A struct containing the trained Classifier20CubicKNN. The
%       struct contains various fields with information about the trained
%       Classifier20CubicKNN.
%
%      trainedClassifier20CubicKNN.predictFcn: A function to make predictions on new
%       data.
%
...
% Classifier20CubicKNN, call the function from the command line with your original
% data or new data as the input argument trainingData.
%
% For example, to retrain a Classifier20CubicKNN trained with the original data set
% T, enter:
%   [trainedClassifier20CubicKNN, validationAccuracy] = trainClassifier20CubicKNN(T)
%
% To make predictions with the returned 'trainedClassifier20CubicKNN' on new data T2,
% use
%   [yfit,scores] = trainedClassifier20CubicKNN.predictFcn(T2)
%
% T2 must be a table containing at least the same predictor columns as used
% during training. For details, enter:
%   trainedClassifier20CubicKNN.HowToPredict

% Auto-generated by MATLAB on 29-Aug-2023 22:21:11
...
% Train a Classifier20CubicKNN
% This code specifies all the Classifier20CubicKNN options and trains the Classifier20CubicKNN.
...
partitionedModel = crossval(trainedClassifier20CubicKNN.ClassificationKNN, 'KFold', 10);
