% carpenter30b19ndmp3groups_AA_Trait_SCD_CoverslipL_singleSplit.m
...
% 3 groups: AA; ABeta-AS; SCD (SBeta-SS)
...
fprintf('\t Number of ABeta-AS in training data = %d \n', length(ABeta_ASTrainInd));
fprintf('\t Number of SCD in training data = %d \n', length(SCDTrainInd));

fprintf('Testing data numbers ..... \n');
fprintf('\t Number of AA in testing data = %d \n', length(AATestInd));
fprintf('\t Number of ABeta-AS in testing data = %d \n', length(ABeta_ASTestInd));
...
fprintf('\t Number of ABeta-AS in training data = %.1f%% \n', length(ABeta_ASTrainInd)*100/nTrain);
...
fprintf('\t Number of ABeta-AS in testing data = %.1f%% \n', length(ABeta_ASTestInd)*100/nTest);
...
nMaxTrain = length(ABeta_ASTestInd);
