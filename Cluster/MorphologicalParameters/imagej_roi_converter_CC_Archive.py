...
#UID = ["Test"]
#dataPath = "/home/shrestha/projects/def-stoeber/shrestha/Cellpose/Outlines/"
#resultsPath = "/home/shrestha/projects/def-stoeber/shrestha/MorphologicalParameters/Nepal/"
...
for tnameInd in range(len(tname)): # Loop through all folders starting with t, such as t0, t2hrs, and so on
	...
	for fInd in range(len(CSIDfull)):
		...
		for fLInd in range(len(fileList)):
			...
			macroImage = "open(\"/home/shrestha/scratch/ImagesNepal/DPC/" + UID + "/" + tname[tnameInd] + "/" + CSIDfull[fInd] + "/" + IDNum +  "_DPC.png\");"
