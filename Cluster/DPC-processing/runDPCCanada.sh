...
#for i in SCT-009 SCT-008 SCT-007
#for i in SCT-006 SCT-005 SCT-004
#for i in SCD-009 SCD-010 SCD-011 SCD-012
for i in SCD-009
do
  # Login node: Create archived folder of raw images for particular UID
#  cd ~/scratch/ImagesCanada/RAW/
